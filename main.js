...
main.prototype.listen = function () {
    ...
    var bgmPausedForBg = false;
    var pauseBgBgm = function () {
        if (!main.core || !main.core.control || !main.core.musicStatus) return;
        try {
            if (main.core.musicStatus.bgmStatus && main.core.musicStatus.playingBgm) {
                main.core.control.pauseBgm();
                bgmPausedForBg = true;
            }
        } catch (e) { }
    };
    var resumeBgBgm = function () {
        if (!bgmPausedForBg) return;
        bgmPausedForBg = false;
        if (main.core && main.core.control) {
            try {
                main.core.control.resumeBgm(true);
            } catch (e) { }
        }
    };
    ...
    window.onfocus = resumeBgBgm;
    document.addEventListener('visibilitychange', function () {
        if (document.hidden) pauseBgBgm();
        else resumeBgBgm();
    });
